...
{
    private const string ApiUrl = "https://api.github.com/repos/TareqAli-CS/ReplayPad/releases/latest";
    public const string ReleasesPage = "https://github.com/TareqAli-CS/ReplayPad/releases";
    ...
    public static async Task<(bool IsNewer, string LatestTag)?> CheckAsync()
    {
        try
        {
            ...
            http.DefaultRequestHeaders.UserAgent.ParseAdd("ReplayPad");
